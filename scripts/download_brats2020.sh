...
OUTPUT_DIR="${OUTPUT_DIR:-./dataset/brats_2020}"

usage() {
  cat <<'EOF'
Usage:
  bash scripts/download_brats2020.sh [--output-dir PATH]

Environment variables:
  OUTPUT_DIR   Where to store the downloaded archive and extracted dataset.

Notes:
  - This script uses the Kaggle mirror for BraTS 2020.
...
echo "Downloading BraTS 2020 from Kaggle: $DATASET_SLUG"
